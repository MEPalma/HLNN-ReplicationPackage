// Taken from: https://github.com/antlr/grammars-v4/blob/cda43d1e0e58baccdf62da56d01b86ab76e88d93/python/python3/Java/Python3LexerBase.java
...
abstract class Python3LexerBase extends Lexer {
    ...
    void onNewLine(){
        ...
        if (opened > 0 || (nextnext != -1 && (next == '\r' || next == '\n' || next == '\f' /*|| next == '#'*/))) { // [Modified]: removed skip on upcoming comment line condition.
